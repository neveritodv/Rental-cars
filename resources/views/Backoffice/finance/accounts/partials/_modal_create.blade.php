            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('backoffice.finance.accounts.store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}" 
                                                   ...
                                                   required maxlength="150" placeholder="Ex: Compte courant, Caisse principale...">
                                            @error('name')
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="rib" value="{{ old('rib') }}" 
                                                   ...
                                                   maxlength="50" placeholder="Numéro de compte bancaire (optionnel)">
                                            @error('rib')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            @error('initial_balance')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Le solde actuel sera égal au solde initial</small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset class="fieldset" id="tab3">
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-device-floppy me-1"></i> Créer le compte
                                    </button>
                                </div>
                            </fieldset>
                        </form>
