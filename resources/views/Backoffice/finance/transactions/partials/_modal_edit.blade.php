                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0 mt-1">
                            Transaction #{{ $financialTransaction->id }}
                        </p>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('backoffice.finance.transactions.update', $financialTransaction) }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="date" value="{{ old('date', $financialTransaction->date->format('Y-m-d')) }}" 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="type" id="type_income" value="income" {{ old('type', $financialTransaction->type) == 'income' ? 'checked' : '' }} required>
                                                    <label class="form-check-label text-success" for="type_income">
                                                        <i class="ti ti-trending-up me-1"></i>Revenu
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="type" id="type_expense" value="expense" {{ old('type', $financialTransaction->type) == 'expense' ? 'checked' : '' }} required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="financial_account_id" class="form-select @error('financial_account_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($accounts as $account)
                                                    <option value="{{ $account->id }}" {{ old('financial_account_id', $financialTransaction->financial_account_id) == $account->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="amount" value="{{ old('amount', $financialTransaction->amount) }}" 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                                                      rows="3">{{ old('description', $financialTransaction->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="reference" value="{{ old('reference', $financialTransaction->reference) }}" 
