    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <h4 class="mb-1">Supprimer la facture</h4>
                <p class="mb-3" id="deleteInvoiceText">Êtes-vous sûr de vouloir supprimer cette facture ?</p>
...
document.addEventListener('DOMContentLoaded', function() {
    const deleteModal = document.getElementById('delete_invoice');
    if (deleteModal) {
        deleteModal.addEventListener('show.bs.modal', function(event) {
            ...
            if (button) {
                ...
                const details = button.getAttribute('data-delete-details') || 'cette facture';
                
                const form = document.getElementById('deleteInvoiceForm');
                const text = document.getElementById('deleteInvoiceText');
