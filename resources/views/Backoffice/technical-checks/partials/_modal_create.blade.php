    ...
    <div class="content me-0">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="mb-3">
                    <a href="{{ route('backoffice.vehicles.technical-checks.index', $vehicle->id ?? 1) }}" class="d-inline-flex align-items-center fw-medium">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('backoffice.vehicles.technical-checks.store') }}" 
                              method="POST" 
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                               ...
                                               value="{{ old('next_check_date', now()->addYear()->format('Y-m-d')) }}"
                                               class="form-control @error('next_check_date') is-invalid @enderror"
                                               required>
                                        @error('next_check_date')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                        <small class="text-muted">Date du prochain contrôle technique</small>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-4">
                                <a href="{{ route('backoffice.vehicles.technical-checks.index', $vehicle->id ?? 1) }}" class="btn btn-light px-4">
