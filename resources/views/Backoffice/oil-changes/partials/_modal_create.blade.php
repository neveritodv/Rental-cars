    ...
    <div class="content me-0">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="mb-3">
                    <a href="{{ isset($vehicle) && $vehicle ? route('backoffice.vehicles.oil-changes.index', $vehicle->id) : route('backoffice.vehicle-documents.oil-changes.index') }}" 
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">
                            <i class="ti ti-droplet-plus me-2"></i>
                            Ajouter une vidange
                        </h4>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('backoffice.vehicle-documents.oil-changes.store') }}" 
                              method="POST" 
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        @error('next_mileage')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                        <small class="text-muted">Doit être supérieur au kilométrage actuel</small>
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Validate next mileage > current mileage
    const mileage = document.querySelector('input[name="mileage"]');
    const nextMileage = document.querySelector('input[name="next_mileage"]');
    
    if (mileage && nextMileage) {
        nextMileage.addEventListener('input', function() {
            if (this.value && mileage.value && parseInt(this.value) <= parseInt(mileage.value)) {
                this.setCustomValidity('Le prochain kilométrage doit être supérieur au kilométrage actuel');
            } else {
