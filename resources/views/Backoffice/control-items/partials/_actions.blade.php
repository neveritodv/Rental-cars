...
<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end p-2">
        ...
        <li>
            <a class="dropdown-item rounded-1" href="{{ route('backoffice.control-items.show', $item) }}">
        ...
        @can('vehicle-control-items.general.edit')
        <li>
            <a class="dropdown-item rounded-1" href="{{ route('backoffice.control-items.edit', $item) }}">
        ...
        <li>
            <a class="dropdown-item rounded-1 text-danger" 
               ...
               data-delete-action="{{ route('backoffice.control-items.destroy', $item) }}"
               data-delete-details="l'élément <strong>{{ $item->item_key }}</strong>">
