            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('backoffice.control-items.store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="vehicle_control_id" class="form-select @error('vehicle_control_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($controls ?? [] as $control)
                                                    <option value="{{ $control->id }}" {{ old('vehicle_control_id') == $control->id || $selectedControlId == $control->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="item_key" value="{{ old('item_key') }}" 
                                                   class="form-control @error('item_key') is-invalid @enderror" 
                                                   maxlength="100" placeholder="Ex: freins, pneus, eclairage...">
                                            @error('item_key')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="label" value="{{ old('label') }}" 
                                                   ...
                                                   maxlength="150" placeholder="Ex: État des freins, Pression des pneus...">
                                            @error('label')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                            ...
                            <fieldset class="fieldset" id="tab2">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="comment" rows="4" 
                                                      ...
                                                      placeholder="Ajoutez un commentaire sur cet élément...">{{ old('comment') }}</textarea>
                                            @error('comment')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Informations complémentaires (max 255 caractères)</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-device-floppy me-1"></i> Créer l'élément
                                    </button>
                                </div>
                            </fieldset>
                        </form>
