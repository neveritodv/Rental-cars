            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('backoffice.payments.store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="reference" value="{{ old('reference') }}" 
                                                   ...
                                                   maxlength="100" placeholder="N° de transaction, chèque...">
                                            @error('reference')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="invoice_id" class="form-select @error('invoice_id') is-invalid @enderror">
                                                ...
                                                @foreach($invoices as $invoice)
                                                    <option value="{{ $invoice->id }}" {{ old('invoice_id', $selectedInvoice?->id) == $invoice->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="method" class="form-select @error('method') is-invalid @enderror" required>
                                                ...
                                                <option value="card" {{ old('method') == 'card' ? 'selected' : '' }}>Carte bancaire</option>
                                                <option value="bank_transfer" {{ old('method') == 'bank_transfer' ? 'selected' : '' }}>Virement</option>
