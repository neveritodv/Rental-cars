    ...
    <div class="modal fade" id="delete_insurance">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <form method="POST" action="#" id="deleteInsuranceForm">
                    @csrf
                    @method('DELETE')
                    ...
                    <div class="modal-body text-center">
                        ...
                        <h4 class="mb-1">Supprimer l'assurance</h4>
                        <p class="mb-3" id="deleteInsuranceText">Êtes-vous sûr de vouloir supprimer cette assurance ?</p>
