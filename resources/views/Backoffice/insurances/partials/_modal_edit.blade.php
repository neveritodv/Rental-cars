            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">
                            <i class="ti ti-shield-edit me-2"></i>
                            Modifier l'assurance
                        </h4>
                        <p class="text-muted mb-0 mt-1">
                            Véhicule: <strong>{{ $vehicle->registration_number }} - {{ $vehicle->registration_city ?? '' }}</strong>
                        </p>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('backoffice.vehicles.insurances.update', [$vehicle->id, $insurance->id]) }}" 
                              method="POST" 
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="vehicle_id" 
                                            ...
                                            @foreach($vehicles as $v)
                                                <option value="{{ $v->id }}" 
                                                    {{ old('vehicle_id', $insurance->vehicle_id) == $v->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               name="company_name"
                                               value="{{ old('company_name', $insurance->company_name) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                               name="date"
                                               value="{{ old('date', $insurance->date->format('Y-m-d')) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                               ...
                                               value="{{ old('next_insurance_date', $insurance->next_insurance_date->format('Y-m-d')) }}"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="notes"
                                                  ...
                                                  rows="4">{{ old('notes', $insurance->notes) }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-4">
                                <a href="{{ route('backoffice.vehicles.insurances.index', $vehicle->id) }}" class="btn btn-light px-4">
