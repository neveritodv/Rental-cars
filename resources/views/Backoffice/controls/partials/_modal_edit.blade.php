            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('backoffice.controls.update', $control) }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="vehicle_id" class="form-select @error('vehicle_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($vehicles ?? [] as $vehicle)
                                                    ...
                                                    @endphp
                                                    <option value="{{ $vehicleId }}" {{ old('vehicle_id', $control->vehicle_id) == $vehicleId ? 'selected' : '' }}>
                                                        {{ $displayText }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="rental_contract_id" class="form-select @error('rental_contract_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($rentalContracts ?? [] as $contract)
                                                    ...
                                                    @endphp
                                                    <option value="{{ $contractId }}" {{ old('rental_contract_id', $control->rental_contract_id) == $contractId ? 'selected' : '' }}>
                                                        {{ $displayText }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="{{ $control->control_number }}" 
                                                   class="form-control bg-light" readonly disabled>
                                            <small class="text-muted">Le numéro de contrôle ne peut pas être modifié</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="start_mileage" value="{{ old('start_mileage', $control->start_mileage) }}" 
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="end_mileage" value="{{ old('end_mileage', $control->end_mileage) }}" 
                                            ...
                                            <small class="text-muted">
                                                @if($control->end_mileage)
                                                    Distance parcourue: {{ number_format($control->total_distance, 0, ',', ' ') }} KM
                                                @else
                                                    Laissez vide si le contrôle est toujours en cours
                                                @endif
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="notes" rows="6" 
                                                      ...
                                                      placeholder="Ajoutez des notes sur l'état du véhicule, observations particulières...">{{ old('notes', $control->notes) }}</textarea>
                                            @error('notes')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
