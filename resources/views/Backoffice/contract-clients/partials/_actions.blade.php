...
<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end p-2">
        ...
        <li>
            <a class="dropdown-item rounded-1" href="{{ route('backoffice.contract-clients.show', $item) }}">
        ...
        @can('contract-clients.general.edit')
        <li>
            <a class="dropdown-item rounded-1" href="{{ route('backoffice.contract-clients.edit', $item) }}">
        ...
        <li>
            <a class="dropdown-item rounded-1 text-danger" 
               ...
               data-bs-target="#delete_contract_client"
               data-delete-action="{{ route('backoffice.contract-clients.destroy', $item) }}"
               data-delete-details="Relation <strong>#{{ $item->id }}</strong>">
