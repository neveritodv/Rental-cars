            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('backoffice.bookings.store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="pickup_location" value="{{ old('pickup_location') }}" 
                                                   ...
                                                   placeholder="Aéroport, gare, adresse..." required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <div class="alert alert-info">
                                                ...
                                                <span id="durationDisplay">Nombre de jours: <strong>0</strong> jour(s)</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset class="fieldset" id="tab3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            @error('estimated_total')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Laissez vide pour calcul automatique basé sur le véhicule</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="source" class="form-select @error('source') is-invalid @enderror" required>
                                                ...
                                                <option value="website" {{ old('source', 'website') == 'website' ? 'selected' : '' }}>Site web</option>
                                                <option value="mobile" {{ old('source') == 'mobile' ? 'selected' : '' }}>Application mobile</option>
                                                <option value="backoffice" {{ old('source') == 'backoffice' ? 'selected' : '' }}>Backoffice</option>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-device-floppy me-1"></i> Créer la réservation
                                    </button>
                                </div>
                            </fieldset>
                        </form>
