    ...
    <div class="content me-0">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="mb-3">
                    <a href="{{ route('backoffice.vehicles.vignettes.index', $vehicle->id ?? 1) }}" class="d-inline-flex align-items-center fw-medium">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('backoffice.vehicles.vignettes.store', ['vehicle' => $vehicle->id ?? 1]) }}" 
                              method="POST" 
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="year"
                                            ...
                                            @for($y = date('Y') + 1; $y >= 2000; $y--)
                                                <option value="{{ $y }}" {{ old('year') == $y || $y == date('Y') ? 'selected' : '' }}>
                                                    {{ $y }}
                                                </option>
                                            @endfor
                                        </select>
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-4">
                                <a href="{{ route('backoffice.vehicles.vignettes.index', $vehicle->id ?? 1) }}" class="btn btn-light px-4">
