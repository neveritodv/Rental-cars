...
var locations =[{
	...
	"car_image":'build/img/car-list-1.jpg',
	"reviews":"(4.0) 160",
	"address":"Newyork, USA",
	"km":"3.0m",
	"amount":"$160",
	"lat":53.470692,
	"lng":-2.220328,
	"icons":"'build/img/icons/car-marker-01.svg'",
	"profile_link":"listing-details",
	"image":'build/img/profiles/avatar-04.jpg'
	}, {
		
	"id":"02",
	"car_brand":"BMW",
	"car_name":"BMW 640 XI Gran Turismo",
	"car_image":'build/img/car-list-2.jpg',
	"reviews":"(4.0) 165 ",
	...
	"icons":"'build/img/icons/car-marker-01.svg'",
	"profile_link":"listing-details",
	"image":'build/img/profiles/avatar-03.jpg'
	}, {
	"id":"03",
	"car_brand":"Ford",
	"car_name":"Ford Mustang, Blue 2014",
	"car_image":'build/img/car-list-3.jpg',
	"reviews":"(4.0) 165 ",
	...
	"icons":"default",
	"profile_link":"listing-details",
	"image":'build/img/profiles/avatar-06.jpg'
	}, {
	"id":"04",
	"car_brand":"Audi",
	"car_name":"Audi A3 2019 new",
	"car_image":'build/img/car-list-5.jpg',
	"reviews":"(4.0) 150 ",
	"address":"Newyork, USA",
	"km":"3.5m",
	"amount":"$45",
	...
	"car_image":'build/img/car-list-6.jpg',
	"reviews":"(4.0) 170  ",
	"address":"Lasvegas, USA",
	"km":"4.1m",
	"amount":"$90",
...
'<div class="listing-item" style="width: 100%; display: inline-block;">'+											
									...
									'<div class="listing-content">'+	
										'<div class="listing-features d-flex align-items-end justify-content-between">'+	
											...
											'</div>'+
											'<div class="list-km">'+
												'<span class="km-count"><img src="build/img/icons/map-pin.svg" alt="author">' + marker.km + '</span>'+
											'</div>'+
										'</div> '+
										'<div class="listing-details-group">'+
											'<ul>'+
												'<li>'+
													'<span><img src="build/img/icons/car-parts-05.svg" alt="Manual"></span>'+
													'<p>Manual</p>'+
												'</li>'+
												'<li>'+
													'<span><img src="build/img/icons/car-parts-02.svg" alt="10 KM"></span>'+
													'<p>10 KM</p>'+
												'</li>'+
												'<li>'+
													'<span><img src="build/img/icons/car-parts-03.svg" alt="Petrol"></span>'+
													'<p>Petrol</p>'+
												'</li>'+
											'</ul>'+	
											'<ul>'+
												'<li>'+
													'<span><img src="build/img/icons/car-parts-04.svg" alt="Power"></span>'+
													'<p>Power</p>'+
												'</li>'+
												'<li>'+
													'<span><img src="build/img/icons/car-parts-05.svg" alt="2019"></span>'+	
													'<p>2019</p>'+	
												'</li>'+	
												'<li>'+	
													'<span><img src="build/img/icons/car-parts-06.svg" alt="Persons"></span>'+	
													'<p>4 Persons</p>'+	
												'</li>'+	
											'</ul>'+	
										'</div>'+																	 
