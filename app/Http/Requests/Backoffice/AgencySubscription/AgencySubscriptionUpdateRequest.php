...
class AgencySubscriptionUpdateRequest extends FormRequest
{
    ...
    {
        $subscription = $this->route('agency_subscription') ?? $this->route('agencySubscription');
        ...
        return [
            'agency_id' => [
                ...
                'integer',
                'exists:agencies,id',
                Rule::unique('agency_subscriptions', 'agency_id')->ignore($subscriptionId),
            ],
